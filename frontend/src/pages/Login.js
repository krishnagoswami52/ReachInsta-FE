...
export default function Login() {
  ...
  return (
    <div className="min-h-screen pt-24 flex items-center justify-center" data-testid="login-page">
      <div className="w-full max-w-md px-4">
        ...
        >
          ...
          <Link to="/signup" className="text-[#FF4500] hover:underline font-medium" data-testid="signup-link">
            Sign up free
          </Link>
        </motion.p>
      </div>
